class TagManager:
    ...
    class ToggleKeyPanelTags:
        ...
        StartListenBtn = 'toggle_key_panel/start_listen_btn'
        ToggleState = 'toggle_key_panel/toggle_state'
    ...
    class AddKeyPanelTags:
        AddedKeyDeviceCombo = 'add_key_panel/add_key_device_combo'
        MouseBtnCombo = 'add_key_panel/mouse_btn_combo'
